<?php
    ...
    $query_for_high="SELECT `highscore` FROM `prime` WHERE `uid`=$user_id";
...
<html>
    ...
    <div class="">
        <div class="row">
            <form name="scoreboard" action="prime_script.php" method="POST">
...
<marquee scrollamount="5">
    ...
    <script language="javascript">
        ...
        function check(value)
        {
			...
			if(scr>=20)
			{
				alert("You won!!! Your score is "+scr);
				if(window.confirm("do you want to play again?"))
				{
					window.location.replace("Prime.php");
				}
				else
				{
		...
		function fun()
		{
			...
			if(seconds==-1)
			{
				...
				// if(window.confirm("do you want to play again?"))
				// {
				// 	window.location.assign("Prime.php");
				// }
				// else
				// {
