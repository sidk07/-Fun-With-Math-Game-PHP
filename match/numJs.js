    ...
    let football =  Math.floor(Math.random() * 10) + 1 ;
    let mask = Math.floor(Math.random() * 10) + 2 ;
    let pizza = Math.floor(Math.random() * 10) + 3 ;
    let lightning = Math.floor(Math.random() * 10) + 4 ;
    let bulb = Math.floor(Math.random() * 10) + 5 ;
    let rocket = Math.floor(Math.random() * 10) + 6 ;
    let bacteria = Math.floor(Math.random() * 10) + 7 ;
    let kiwi = Math.floor(Math.random() * 10) + 8 ;
    let cocktail = Math.floor(Math.random() * 10) + 9 ;
